...
import { CotejoDocumentos } from '../utils/acciones';
...
export const BuscarCotejoDoc = ( { navigation }: Props ) => {
   ...
   const { Identificador, onChange } = useForm({
      Identificador : ""
   });
   ...
   const consultarAPI = async () => {
    ...
    let response = await CotejoDocumentos( Identificador )
   ...
   const validarCriterio = () => {
       ...
       if(!Identificador){
           Alert.alert(
               "",
               "Debe introducir el Identificador de Documento",
               [
                 { text: "Ok", onPress: () => null }
               ]
             )
            ...
            >
                ...
                <View style={ consultaStyles.formContainer }>    
                   ...
                   <View style={{paddingBottom: 60}} ></View>
                    ...
                    <TextInput 
                        placeholder="Identificador del Documento"
                        ...
                        onChangeText={ (value) => onChange(value, 'Identificador') }
